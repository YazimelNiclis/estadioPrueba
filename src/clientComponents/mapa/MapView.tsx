...
function MapView() {
    ...
    return (
        <div className="h-full w-full overflow-auto border-r-2 border-r-slate-300 bg-slate-200 shadow-inner md:col-span-3">
            <Map
                ...
                onZoom={(e) =>
                    handleZoom(e, mapRef, initialView, zoom, lastZoom)
                }
                maxBounds={bounds}
